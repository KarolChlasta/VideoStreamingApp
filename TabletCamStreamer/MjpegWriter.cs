...
namespace TabletCamStreamer
{
    public class MjpegWriter : IDisposable
    {
        ...
        public void Write(Image image, bool keepTransparent)
        {
            MemoryStream ms = BytesOf(image, keepTransparent);
            this.Write(ms);
        }
        ...
        private static MemoryStream BytesOf(Image image,bool keepTransparent)
        {
