...
namespace TabletCamStreamer
{
    public class StreamingServer:IDisposable
    {
        ...
        bool _isStreamFrameTransparent;
        public StreamingServer(IEnumerable<Image> imagesSource, bool isStreamFrameTransparent)
        {
            _Thread = null;
            ...
            this.Interval = 50;
            _isRunning = false;
            _isStreamFrameTransparent = isStreamFrameTransparent;
        }
            ...
            try
            {
                using (MjpegWriter wr = new MjpegWriter(new NetworkStream(socket, true)))
                {
                    ...
                    foreach (Image img in this.ImagesSource)
                    {
                        ...
                        wr.Write(img,_isStreamFrameTransparent);
                    }
